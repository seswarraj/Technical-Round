...
class Botiga_Metabox {
	...
	public function add_metabox( $post_type ) {
		...
		$metabox_title = 'Uplers Options';

		switch ( $post_type ) {

			case 'post':
				$metabox_title = esc_html__( 'Uplers Post Options', 'botiga' );
			break;

			case 'page':
				$metabox_title = esc_html__( 'Uplers Page Options', 'botiga' );
			break;

			case 'product':
				$metabox_title = esc_html__( 'Uplers Product Options', 'botiga' );
			break;

			case 'size_chart':
				$metabox_title = esc_html__( 'Uplers Size Chart Options', 'botiga' );
			break;

			case 'linked_variation':
				$metabox_title = esc_html__( 'Uplers Linked Variation Options', 'botiga' );
			break;
